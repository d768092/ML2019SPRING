...
from keras.layers import Dense, LSTM, Dropout, Reshape, BatchNormalization, Flatten, Embedding
...
checkpoint = ModelCheckpoint('LSTM2-{epoch:d}.model', monitor='val_acc', verbose=1, save_best_only=True, mode='max')
